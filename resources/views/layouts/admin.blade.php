...
<h1 class="site-title"><a href="/"><img src="{{asset('images/logo-light.png')}}" alt=""> Home </a></h1>
...
<li class="nav-item"><a class="nav-link {{Request::path()=="admin/events" ? 'active' : ''}}" href="/admin/users"><em class="fas fa-user"></em> User </a></li>
<li class="nav-item">
...
<main class="col-xs-12 col-sm-8 col-lg-9 col-xl-10 pt-3 pl-4 ml-auto">
        <header class="page-header row justify-center">
                ...
                <img src="{{asset('img/b3.jpg')}}" alt="profile photo" class="circle float-left profile-photo" width="50" height="auto">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" style="margin-right: 1.5rem;" aria-labelledby="dropdownMenuLink"><a class="dropdown-item" href="#"><em class="fa fa-user-circle mr-1"></em> Information</a>
